...
export function LoyaltyView() {
 ...
 <p className="text-xs uppercase tracking-widest text-[#2f6cf5] font-extrabold leading-none mb-1">Retention</p>
 <p className="text-lg font-extrabold text-foreground">84%</p>
 </div>
 <div className="w-px h-8 bg-border/50" />
 <div className="text-center">
 <p className="text-xs uppercase tracking-widest text-[#2f6cf5] font-extrabold leading-none mb-1">Referrals</p>
 ...
 <span className="text-xs text-muted-foreground font-bold uppercase tracking-widest">Tích điểm</span>
 </div>
 </div>
 </Card>
 ))}
 ...
 <span className={cn("inline-block px-2.5 py-0.5 text-xs font-black uppercase tracking-wide rounded-full border mb-1.5", matchedPreset.badge)}>
 {rule.tag}
 </span>
 ...
 <span className="text-xs text-muted-foreground font-medium">Khách hàng đạt yêu cầu:</span>
 ...
 <span className="text-xs uppercase font-bold tracking-widest text-[#2f6cf5]">Trình kiểm tra tệp</span>
 <span className={cn("px-2 py-0.5 text-xs font-bold rounded shadow-2xs border", colorMeta.badge)}>
 {activeRule.tag}
 </span>
 </div>
 <h4 className="font-bold text-sm text-foreground truncate">{activeRule.name}</h4>
 <p className="text-xs text-muted-foreground mt-0.5">Tìm thấy {matchedCustomers.length} khách hàng thỏa quy chuẩn.</p>
 </div>
 ...
 {!er.isActive && <Badge variant="outline" className="text-xs uppercase">Vô hiệu</Badge>}
 </div>
 ...
 <Badge variant={camp.isActive ? "default" : "outline"} className="text-xs tracking-widest">
