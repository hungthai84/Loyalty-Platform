          ...
          >
            ...
            {activeTab === "engagement" && (
              <div className="grid gap-8 md:grid-cols-3">
                    ...
                    {earnRules.map((er) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs text-muted-foreground mt-1">
                            Tặng +{er.points.toLocaleString()} pts khi hoàn
                            thành
                          </p>
                        </div>
                ...
                <motion.div
                  ...
                  className="space-y-6"
                >
                  <Card className="border border-indigo-500/20 border-none bg-gradient-to-br from-indigo-500/10 to-purple-500/10 p-6 shadow-sm transition-all hover:shadow-md">
                    <h4 className="font-bold text-lg mb-2 flex items-center">
                      <Scissors className="w-5 h-5 mr-2 text-indigo-500" /> AI
                      Personalization
                    </h4>
                    <p className="text-xs text-muted-foreground leading-relaxed">
                      AI học lịch sử mua và phong cách để đề xuất quà tặng cá
                      nhân hóa. Tự động nâng nhân hạng điểm khi khách dùng tính
                      năng "AI Stylist".
                    </p>
                  </Card>
                </motion.div>
            ...
            {activeTab === "automation" && (
              <div className="space-y-8">
                <div className="flex items-center justify-between">
                  <h3 className="text-xl font-bold font-heading flex items-center gap-2">
                    <Zap className="w-5 h-5 text-amber-500" /> Automation &
                    Campaigns
                  </h3>
                </div>
                    ...
                    {campaigns.map((camp) => (
                      ...
                      >
                        <Card
                          ...
                          className={cn(
                            "relative h-full cursor-pointer border-none glass-card p-6 transition-all hover:shadow-xl",
                        ...
                        >
                          ...
                          <h4 className="mb-2 text-lg font-bold leading-none">
                            {camp.name}
                          </h4>
                          <p className="mb-6 line-clamp-2 text-xs text-muted-foreground">
                            {camp.description ||
