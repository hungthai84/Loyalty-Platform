        ...
        <div className="flex flex-wrap items-center gap-2.5">
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="font-mono">{formatRangeText()}</span>
                ...
                <>
                  ...
                  <div className="absolute left-0 mt-2 w-72 bg-card border border-border shadow-2xl rounded-[1.25rem] p-4.5 z-20 text-left animate-in fade-in-50 slide-in-from-top-2 duration-150">
                    <div className="space-y-4">
                      <div className="text-[10px] font-extrabold text-[#2f6cf5] uppercase tracking-widest flex items-center gap-1.5">
                        ...
                        {presets.map((p) => {
                          ...
                          return (
                            <button
                              ...
                              className={`px-3 py-2 text-[11px] font-bold rounded-xl text-left transition-all cursor-pointer ${
                                isActive
                      ...
                      <div className="pt-3.5 border-t border-border/80 space-y-2.5">
                        <span className="text-[9px] font-extrabold text-muted-foreground uppercase tracking-widest block">Khoảng ngày tùy chỉnh</span>
                        <div className="grid grid-cols-2 gap-2">
                          <div className="space-y-1">
                            <label className="text-[8px] font-bold text-muted-foreground uppercase block">Từ ngày</label>
                            <input
                              type="date"
                              value={startDate}
                              onChange={(e) => handleCustomDateChange("start", e.target.value)}
                              className="w-full bg-background border border-border rounded-xl p-2 text-[10px] outline-none font-mono focus:border-primary/50 text-foreground"
                            />
                          </div>
                          <div className="space-y-1">
                            <label className="text-[8px] font-bold text-muted-foreground uppercase block">Đến ngày</label>
                            <input
                              type="date"
                              value={endDate}
                      ...
                      <div className="flex justify-end gap-1.5 pt-1">
                        <button
                          ...
                          className="px-3 py-1.5 bg-primary text-white text-[10px] font-bold rounded-lg cursor-pointer hover:bg-primary/95 shadow-sm"
                        >
                          Áp dụng
                        </button>
                      </div>
              ...
              {isTierOpen && (
                <>
                  ...
                  <div className="absolute left-0 mt-2 w-48 bg-card border border-border shadow-2xl rounded-[1.25rem] p-2.5 z-20 text-left animate-in fade-in-50 slide-in-from-top-2 duration-150">
                    <div className="text-[9px] font-extrabold text-muted-foreground uppercase tracking-widest px-2.5 py-1.5 border-b border-border/60">
