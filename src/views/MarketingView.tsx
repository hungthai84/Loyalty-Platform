...
export function MarketingView() {
 ...
 <div>
 <div className="text-xl font-black ">{campaignRules.filter(r => r.status === 'active').length}</div>
 <div className="text-xs text-muted-foreground uppercase font-black tracking-wider">Đang hoạt động</div>
 </div>
 </div>
 <Badge variant="outline" className="text-xs border-emerald-500/20 bg-emerald-500/5 text-emerald-600">Ổn định</Badge>
 </div>
 ...
 <div>
 <div className="text-xl font-black ">1,348</div>
 <div className="text-xs text-muted-foreground uppercase font-black tracking-wider">Lần Kích Hoạt</div>
 </div>
 </div>
 ...
 <div>
 <div className="text-xl font-black ">89.4%</div>
 <div className="text-xs text-muted-foreground uppercase font-black tracking-wider">Đọc Tin Nhắn</div>
 </div>
 </div>
 <Badge variant="outline" className="text-xs border-blue-500/25 bg-blue-500/5 text-blue-500">Zalo/SMS</Badge>
 </div>
 ...
 <div className="text-xs text-muted-foreground uppercase font-black tracking-wider">Tỷ lệ đổi quà</div>
 </div>
 </div>
 <Badge variant="outline" className="text-xs border-[#2f6cf5]/35 bg-[#2f6cf5]/10 text-[#2f6cf5]">ROI Cao</Badge>
 </div>
 </div>
 ...
 <label className="text-xs font-bold text-muted-foreground uppercase">Tên Quy Tắc / Chiến Dịch</label>
 <input 
 type="text" 
 required
 value={newCamName}
 ...
 <div className="space-y-1.5">
 <label className="text-xs font-bold text-muted-foreground uppercase">Trình kích hoạt (Trigger)</label>
 <select
 value={newCamTrigger}
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <div className="space-y-1.5">
 <label className="text-xs font-bold text-muted-foreground uppercase">Kênh gửi (Action Channel)</label>
 <select
 value={newCamAction}
 ...
 <div className="space-y-1.5">
 <label className="text-xs font-bold text-muted-foreground uppercase">Placeholders Hỗ trợ</label>
 <div className="flex flex-wrap gap-2 pt-1">
 <span className="px-2 py-1 bg-muted rounded text-xs select-all cursor-pointer font-bold text-foreground">{"{customer_name}"}</span>
 <span className="px-2 py-1 bg-muted rounded text-xs select-all cursor-pointer font-bold text-foreground">{"{points}"}</span>
 </div>
 </div>
 </div>

 <div className="space-y-1.5">
 <label className="text-xs font-bold text-[#2f6cf5] uppercase flex items-center gap-1.5 ">
 ...
 Quy tắc & Trình Kích hoạt Tự động <span className="px-2 py-0.5 bg-primary/10 text-primary text-xs rounded-full uppercase">Realtime</span>
 </h3>
 ...
 <span className="inline-flex items-center gap-1 px-1.5 py-0.5 bg-primary/15 text-primary text-xs font-black uppercase rounded">
 <Check className="w-2.5 h-2.5" /> Chọn Thử nghiệm
 </span>
 )}
 </h4>
 <div className="flex items-center gap-2.5 mt-1">
 <Badge variant="outline" className="text-xs border-border text-muted-foreground py-0 h-4 px-1.5 font-bold">
 ...
 className={cn(
 "text-xs uppercase font-black px-2.5 py-1 rounded-lg border transition-all cursor-pointer",
 selectedRuleId === rule.id 
 ? "bg-primary text-primary-foreground border-primary" 
 : "hover:bg-muted border-border text-muted-foreground text-xs"
 )}
 >
 Dùng Thử nghiệm
 </button>
 ...
 className={cn(
 "text-xs px-2 py-1 rounded-lg font-black transition-all cursor-pointer",
 rule.status === 'active' 
 ...
 <div className="absolute top-4 right-4 z-40 bg-emerald-500/10 text-emerald-500 text-xs font-black uppercase tracking-widest px-2.5 py-0.5 rounded-full border border-emerald-500/20">
 ⚡ SANDBOX INTERACTIVE
 </div>
 ...
 <label className="text-xs font-bold text-muted-foreground">1. CHỌN KHÁCH HÀNG VIP</label>
 <select
 ...
 <div className="space-y-1">
 <label className="text-xs font-bold text-[#2f6cf5]">2. KỊCH BẢN ĐANG CHỌN</label>
 <input 
 type="text" 
 disabled 
 ...
 <span className="text-xs text-muted-foreground font-black uppercase">Thông tin thiết bị</span>
 ...
 className="py-1.5 px-3 bg-slate-900 hover:bg-[#2f6cf5] hover:text-slate-950 text-white font-black text-xs tracking-widest uppercase rounded-lg transition-all flex items-center gap-1 cursor-pointer"
 >
 ...
 >
 <div className="flex items-center gap-1.5 text-xs font-black text-[#2f6cf5] uppercase tracking-wider">
 <Zap className="w-2.5 h-2.5" /> Triêu hồi tự động: {campaignRules.find(r => r.id === selectedRuleId)?.action || "CRM"}
 </div>
 <p className="text-xs leading-tight text-slate-100 font-bold mt-1">
 ...
 <div className="flex justify-between items-center text-xs text-zinc-300 font-bold tracking-tight ">
 <span>09:41</span>
 ...
 <div className="space-y-1">
 <h4 className="text-xs font-black">Phòng Hộp Chat Zalo VIP</h4>
 <p className="text-xs text-zinc-300">Seva Atelier Official Account</p>
 </div>
 
 <div className="w-full bg-white/10 p-2.5 rounded-xl text-left text-xs font-medium leading-relaxed max-h-[140px] overflow-y-auto mt-2 border border-white/5">
 ...
 <div className="space-y-1">
 <h4 className="text-xs font-black">Atelier Mailbox</h4>
 <p className="text-xs text-zinc-300">Tiêu đề: Ưu đãi Độc Quyền</p>
 </div>

 <div className="w-full bg-white/15 p-2.5 rounded-xl text-left text-xs leading-relaxed max-h-[140px] overflow-y-auto mt-2 border border-white/5">
 {smsHasDispatched ? (
 <div className="space-y-1.5">
 ...
 <div className="space-y-1">
 <h4 className="text-xs font-black">Hộp thư Tin nhắn SMS</h4>
 <p className="text-xs text-zinc-300">CRM-Gateway: +19008198</p>
 </div>

 <div className="w-full bg-slate-800/80 p-2.5 rounded-xl text-left text-xs font-medium leading-relaxed max-h-[140px] overflow-y-auto mt-2 border border-white/5">
 ...
 <div className="flex items-center gap-1 text-xs text-[#2f6cf5] tracking-wider uppercase animate-pulse">
 ...
 <div className="text-center text-xs text-zinc-500 font-bold select-none pt-1">
 Slide To Unlock
 </div>
 </div>
 </div>
 ...
 <div className="bg-background border rounded-xl overflow-hidden text-xs max-h-[100px] overflow-y-auto text-muted-foreground divide-y divide-border border-border">
 ...
 <div>
 <label className="block text-xs text-muted-foreground font-bold uppercase mb-1">SendGrid API Key</label>
 <input 
 type="password" 
 value={sgApiKey}
 ...
 />
 <span className="text-xs text-muted-foreground mt-1 block">Khuyến nghị khai báo <code>SENDGRID_API_KEY</code> trong tệp bảo mật <code>.env</code>.</span>
 </div>

 <div className="grid grid-cols-2 gap-3">
 <div>
 <label className="block text-xs text-muted-foreground font-bold uppercase mb-1">Email Người gửi (From)</label>
 <input 
 type="email" 
 value={sgFromEmail}
 ...
 <div>
 <label className="block text-xs text-muted-foreground font-bold uppercase mb-1">Tên Người gửi</label>
 <input 
 type="text" 
 value={sgFromName}
 ...
 <div>
 <label className="block text-xs text-muted-foreground font-bold uppercase mb-1">Phong cách Giao diện (Email Style)</label>
 ...
 <div>
 <label className="block text-xs text-muted-foreground font-bold uppercase mb-1">Tiêu đề Email (Subject Line)</label>
 <input 
 type="text" 
 value={sgSubject}
 ...
 <div>
 <label className="block text-xs text-muted-foreground font-bold uppercase mb-1">Văn bản lời chúc (Greeting Content)</label>
 <textarea 
 ...
 <div>
 <label className="block text-xs text-muted-foreground font-bold uppercase mb-1">Mã Gift Voucher Tặng kèm</label>
 <input 
 type="text" 
 value={sgVoucherCode}
 onChange={(e) => setSgVoucherCode(e.target.value)}
 placeholder="BDAYVIP5000"
 className="w-full p-2 bg-background border rounded-xl text-xs font-bold tracking-widest text-primary uppercase"
 />
 </div>
 </div>
 ...
 <p className="text-xs text-muted-foreground">Thư sẽ xuất hiện hệt như thế này trong hộp thư đến của hội viên VIP.</p>
 </div>
 <Badge variant="outline" className="text-xs border-amber-500/20 bg-amber-500/5 text-amber-500 font-bold">Responsive</Badge>
 </div>
 ...
 <div className="bg-background text-muted-foreground text-xs px-3.5 py-1 rounded-lg w-full max-w-sm truncate text-left border border-border/40 flex items-center justify-between">
 <span>{sgSubject}</span>
 </div>
 </div>

 {/* Mail Header Meta Info */}
 <div className="p-4 border-b text-xs text-muted-foreground space-y-1 bg-muted/10 text-left">
