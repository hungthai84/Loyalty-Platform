...
export function SettingsView() {
  ...
  const handleSendTestAlert = () => {
    ...
    setTimeout(() => {
      toast.success(
        `Email thông báo cảnh báo đã được gửi thành công đến ${alertEmail}! Nội dung mẫu: Phát hiện một số hội viên có số dư giảm dưới ngưỡng ${pointThreshold} điểm.`
      );
    }, 1000);
  };
  ...
  const [automationRules, setAutomationRules] = useState([
    ...
    { id: "r2", name: "Chào mừng hội viên mới", trigger: "New Account Signup", action: "Award 100 Points", active: true },
                      ...
                      {isAlertEnabled && (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                          <div className="space-y-1.5 text-left">
                            ...
                            />
                            <p className="text-[11px] text-muted-foreground">Ví dụ: Hệ thống phát cảnh báo khi hội viên giảm xuống dưới 500 điểm.</p>
                          </div>
