    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center p-6 bg-sidebar/50 border border-[#D4AF37]/20 rounded-3xl backdrop-blur-md gap-4">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <span className="text-xs font-bold text-muted-foreground font-mono">Chiến dịch mẫu:</span>
          <select 
            value={selectedCamId} 
          ...
          <div className="space-y-4 pr-1">
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-xs font-semibold">
                ...
                <span className="text-foreground font-mono font-bold">{targetSize} KH</span>
              </div>
              <input 
                type="range" 
                min="10" 
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-xs font-semibold">
                ...
                <span className="text-foreground font-mono font-bold text-emerald-500">{redemptionRate}%</span>
              </div>
              <input 
                type="range" 
                min="5" 
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-xs font-semibold">
                ...
                <span className="text-foreground font-mono font-bold text-sky-500">{formatShortVND(expectedAOV)}</span>
              </div>
              <input 
                type="range" 
                min="2000000" 
            ...
            <div className="space-y-2 pt-2 border-t border-border/30">
              <div className="flex justify-between items-center">
                <label className="text-[10px] font-bold text-muted-foreground uppercase">Chi phí vận hành và in ấn (₫)</label>
                <span className="text-[11px] font-mono font-black text-foreground">{formatVND(fixedOverhead)}</span>
              </div>
              <input 
                type="text" 
                inputMode="numeric"
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="p-4 bg-sidebar/50 rounded-2xl border border-border/50 flex flex-col justify-between">
              ...
              <h4 className="text-2xl font-black font-heading mt-2 font-mono">
            ...
            <div className="p-4 bg-sidebar/50 rounded-2xl border border-border/50 flex flex-col justify-between">
              <span className="text-[10px] uppercase font-bold text-emerald-500 leading-none flex items-center gap-1">
                <TrendingUp className="w-3.5 h-3.5" /> Doanh thu bồi đắp
              </span>
              <h4 className="text-2xl font-black font-heading mt-2 font-mono text-emerald-500 truncate">
            ...
            <div className="p-4 bg-sidebar/50 rounded-2xl border border-[#D4AF37]/30 flex flex-col justify-between relative overflow-hidden">
              ...
              <h4 className="text-2xl font-black font-heading mt-2 font-mono text-primary truncate">
          ...
          <div className="bg-card border border-border/60 rounded-2xl p-6 space-y-4">
            ...
            <div className="h-[180px] w-full mt-2 text-xs font-mono">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-card border border-border/60 rounded-2xl p-5 md:col-span-2 space-y-3">
              <h5 className="text-[11px] font-bold text-foreground">HIỆU QUẢ PHÂN BỔ THEO PHÂN CẤP CỦA HỘI VIÊN</h5>
              <div className="h-[130px] w-full text-xs font-mono">
                <ResponsiveContainer width="100%" height="100%">
        ...
        <div className="bg-gradient-to-r from-[#D4AF37]/10 via-[#D4AF37]/5 to-[#D4AF37]/10 border border-[#D4AF37]/40 rounded-3xl p-6 relative overflow-hidden animate-fade-in">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-6 pt-5 border-t border-[#D4AF37]/20 bg-background/40 p-4 rounded-2xl border border-border/40">
            ...
            <div className="space-y-0.5">
              ...
              <p className="text-xs font-black text-sky-500 font-mono">{formatVND(aiAnalysisResult.suggestedAovTarget)}</p>
            </div>
            <div className="space-y-0.5">
              <span className="text-[9px] text-muted-foreground uppercase font-bold">ROI Biên kỳ vọng tối đa (Projected ROI Ceiling)</span>
              <p className="text-xs font-black text-emerald-500 font-mono">+{aiAnalysisResult.roiBumping}%</p>
            </div>
          </div>
