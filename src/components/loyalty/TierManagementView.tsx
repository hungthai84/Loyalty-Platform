...
export function TierManagementView() {
 ...
 <h5 className="text-xs font-bold uppercase tracking-widest text-muted-foreground">Điều kiện đạt hạng</h5>
 <button 
 ...
 <p className="text-xs text-muted-foreground font-bold uppercase">Tổng điểm</p>
 <p className="text-lg font-bold text-primary">{tier.threshold.toLocaleString()} PTS</p>
 </div>
 ...
 <p className="text-xs font-bold uppercase tracking-tight text-muted-foreground">Hội viên hiện tại</p>
 </div>
 </div>
 </CardContent>
 </Card>
