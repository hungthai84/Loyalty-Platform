        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="p-6 space-y-5 max-h-[70vh] overflow-y-auto">
            ...
            <div className="p-3 bg-muted/20 border border-border/40 rounded-xl flex items-center justify-between">
              ...
              <span className={cn("px-3 py-1 rounded-full text-xs font-bold border font-mono transition-all uppercase tracking-wide", selectedPresetColor.border)}>
                {tag || "EXAMPLE_TAG"}
              </span>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full px-4 py-2 bg-background border rounded-xl focus:ring-1 focus:ring-primary outline-none text-sm transition-all font-mono"
                  value={value}
            ...
            <div className="flex items-center justify-between p-4 border rounded-2xl bg-muted/20">
              <div>
                ...
                <span className="text-[11px] text-muted-foreground leading-none">Quy tắc tự động chạy khi kích hoạt</span>
              </div>
              <input 
                type="checkbox"
                checked={isActive}
