          ...
          <div className="p-6 space-y-8">
            <div className="space-y-4">
              <div className="flex items-start gap-4 p-4 bg-amber-500/10 border border-amber-500/20 rounded-xl">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-amber-600/80 uppercase font-bold tracking-tight">Cảnh báo khách hàng bắt đầu ít tương tác</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                ...
                />
                <div className="w-20 text-center bg-muted px-3 py-1 rounded-lg font-mono font-bold text-amber-600">
                  {inactiveDays}d
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4 p-4 bg-rose-500/10 border border-rose-500/20 rounded-xl">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-rose-600/80 uppercase font-bold tracking-tight">Kích hoạt các chiến dịch Win-back ngay lập tức</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <input 
                ...
                />
                <div className="w-20 text-center bg-muted px-3 py-1 rounded-lg font-mono font-bold text-rose-600">
                  {churnDays}d
                </div>
              </div>
            </div>
            ...
            <div className="p-4 bg-muted/30 rounded-xl border border-border flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-[10px] text-muted-foreground uppercase tracking-widest font-bold">Cập nhật realtime dựa trên last transaction</p>
              </div>
              <button 
                type="button"
