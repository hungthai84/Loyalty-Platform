  ...
  return (
    <div className="bg-card border border-border/55 rounded-3xl p-6 shadow-xl space-y-6 max-w-4xl mx-auto">
      <div className="flex items-start justify-between border-b pb-4 border-border/40">
        ...
        <div className="p-1 px-3 bg-primary/10 text-primary text-[10px] font-black uppercase rounded-full tracking-wider shrink-0">
          SLA Sandbox
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-muted/20 p-5 rounded-2xl border border-border/30">
        ...
        <div className="flex flex-col justify-center space-y-4 border-t md:border-t-0 md:border-l border-border/50 pt-4 md:pt-0 md:pl-5">
          <div className="space-y-2">
            <span className="text-[10px] uppercase font-bold text-muted-foreground tracking-wider block">TIẾN TRÌNH THỰC HIỆN</span>
            ...
            <p className="text-[11px] font-mono text-primary font-bold">{statusText || "Hệ thống sẵn sàng nạp dữ liệu."}</p>
          </div>
      ...
      <div className="flex items-center gap-2 text-[11px] text-muted-foreground bg-muted/40 p-3 rounded-xl border border-border/30">
