...
export function SystemStatusMonitor() {
 ...
 Thời gian kiểm chuẩn thực tế mạng: <span className="font-bold text-primary">{fbLatency || "--"}ms</span> với Firestore và <span className="font-bold text-primary">{apiLatency || "--"}ms</span> với API gateway.
 </p>
 </div>
 </div>
 ...
 <span className={cn(
 "px-2 py-0.5 text-xs uppercase font-black tracking-wide border rounded-full leading-none",
 ...
 <h4 className="text-3xl font-black font-heading tracking-tight text-foreground ">
 ...
 <span className="px-2 py-0.5 text-xs uppercase font-black tracking-wide border rounded-full leading-none bg-emerald-500/10 text-emerald-500 border-emerald-500/20">
 operational
 </span>
 </div>
 <div className="space-y-0.5">
 ...
 <div className="flex-1 overflow-y-auto text-xs space-y-1.5 max-h-[290px] pr-1 scrollbar-none scroll-smooth">
