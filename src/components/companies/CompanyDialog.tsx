...
export function CompanyDialog({ onClose, company }: CompanyDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(company ? "Đã cập nhật thông tin" : "Đã tạo công ty/chi nhánh mới");
      onClose();
    } catch (error) {
      console.error(error);
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-[10px] text-muted-foreground">Nếu để trống, hệ thống sẽ tự tạo logo theo tên.</p>
            </div>
