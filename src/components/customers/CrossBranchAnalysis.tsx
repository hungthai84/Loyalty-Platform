                  ...
                  {overlapResults.map((group, idx) => (
                    <div key={idx} className="border border-border/80 rounded-xl overflow-hidden shadow-sm">
                      <div className="bg-muted/30 p-3 px-4 flex items-center justify-between border-b border-border">
                        <div className="font-mono text-xs font-bold text-primary">Biến số chung: <span className="text-foreground">{group.matchValue}</span></div>
                        <div className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest bg-background border px-2 py-0.5 rounded-full">
