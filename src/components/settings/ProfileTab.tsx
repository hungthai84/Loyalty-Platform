...
export function ProfileTab() {
 ...
 <label className="text-xs font-black text-muted-foreground uppercase tracking-widest">Họ và tên hiển thị</label>
 <input 
 type="text" 
 required
 value={displayName}
 ...
 Hệ thống ghi nhận Email của bạn ĐÃ LIÊN KẾT thành công với User ID nội bộ: <span className="underline text-emerald-800 bg-emerald-500/20 px-1.5 py-0.5 rounded ml-1">{existingLinkedId}</span>. 
 ...
 <label className="text-xs font-black text-muted-foreground uppercase tracking-widest block">Tên truy cập nội bộ (User ID)</label>
 <input 
 type="text" 
 ...
 <div className="space-y-1.5">
 <label className="text-xs font-black text-muted-foreground uppercase tracking-widest">Mật khẩu mới</label>
 <input 
 type="password" 
 value={password}
 ...
 <div className="space-y-1.5">
 <label className="text-xs font-black text-muted-foreground uppercase tracking-widest">Xác nhận mật khẩu</label>
 <input 
 type="password" 
